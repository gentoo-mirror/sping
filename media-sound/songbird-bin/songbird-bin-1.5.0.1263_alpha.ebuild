...
MY_PN="Songbird"
MY_PV=$(replace_version_separator 3 'a-' $(get_version_component_range 1-4))
...
SRC_URI="x86? ( http://developer.songbirdnest.com/builds/trunk/${MY_BUILD}/${MY_PN}_${MY_PV}_linux-i686.tar.gz )
	amd64? ( http://developer.songbirdnest.com/builds/trunk/${MY_BUILD}/${MY_PN}_${MY_PV}_linux-x86_64.tar.gz )"
...
S="${WORKDIR}/${MY_PN}_build-${MY_BUILD}"
...
src_install() {
	...
	fperms 755 /opt/songbird/songbird || die "fperms failed"
	fperms 755 /opt/songbird/songbird-bin || die "fperms failed"
	dosym /opt/songbird/songbird /opt/bin/songbird-bin || die "dosym failed"
