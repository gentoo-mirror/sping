...
src_prepare() {
	...
	## TODO epatch "${FILESDIR}"/${PN}-4.2.3-app-defaults.patch #219323
	epatch "${FILESDIR}"/${PN}-4.2.3-disable-texhash.patch #201871
	## TODO epatch "${WORKDIR}"/${PN}-4.2.5-lua-term.patch #233475
	## TODO epatch "${FILESDIR}"/${PN}-4.2.5-configure-pkgconfig.patch #233475 c9
	# Add Gentoo version identification since the licence requires it
	## TODO epatch "${FILESDIR}"/${PN}-gentoo-version.patch
